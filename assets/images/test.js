...
function startVideo(videoElement, successCallback, highRes = false, facingMode = "user") {
    ...
    navigator.mediaDevices.getUserMedia(constraints)
        .then(function (mediaStream) {
            ...
            let dl = mediaStream.getVideoTracks()[0].label.toLowerCase();
            if (isVirtualDevice(mediaStream)) {
                return dl;
            }
            ...
            videoElement.onloadedmetadata = function (e) {
                ...
                videoElement.play();
                if (successCallback) { successCallback(videoElement, mediaStream, dl); }
            };
        })
        .catch(function (err) {
