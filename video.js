...
//     const outputFilename = `./images/image${i}.png`;
...
// async function analyzeMotion(isMobile) {
//     const images = await captureImages();

//     if (images.length < 2) {
//         console.log('Insufficient images for motion detection.');
//         return;
//     }
...
//         console.log(`Movement percentage between image1 and image${i + 2}:`, movementPercentage);
...
// analyzeMotion(false).then(({ firstImageBlob, secondImageBlob }) => {
//     console.log('First image blob:', firstImageBlob);
//     console.log('Second image blob:', secondImageBlob);
// }).catch(error => {
